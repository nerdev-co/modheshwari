...
FROM base AS deps
RUN apt-get update && apt-get install -y --no-install-recommends python3 make g++ node-gyp ca-certificates && rm -rf /var/lib/apt/lists/*
