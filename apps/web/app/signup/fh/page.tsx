    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      >
        <Card className="p-8">
          <div className="text-center mb-8">
            <motion.div
              ...
              className="inline-flex items-center justify-center h-16 w-16 rounded-xl bg-saffron text-ink text-lg font-bold mb-4"
            >
          ...
          <div className="space-y-5">
            <div>
              <label htmlFor="fh-fullName" className="block text-xs font-medium text-ink-secondary mb-2">
            ...
            <div>
              <label htmlFor="fh-email" className="block text-xs font-medium text-ink-secondary mb-2">
            ...
            <div>
              <label htmlFor="fh-password" className="block text-xs font-medium text-ink-secondary mb-2">
            ...
            <div>
              <label htmlFor="fh-familyName" className="block text-xs font-medium text-ink-secondary mb-2">
                {t("signup.fh.familyNameLabel")}
              </label>
              <div className="relative">
                <Users className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-ink-muted" />
                <Input
                  id="fh-familyName"
                  className="pl-11 pr-4 py-3 rounded-lg"
        ...
        <motion.div
          ...
          className="mt-6 bg-surface rounded-xl p-4 border border-border"
        >
